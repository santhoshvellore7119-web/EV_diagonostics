function [params, mode_info] = degradation_mode_library(mode_input, soh_estimate)
%DEGRADATION_MODE_LIBRARY Get parameters for different degradation modes with mixed-mode support
%
%   [PARAMS, MODE_INFO] = DEGRADATION_MODE_LIBRARY(MODE_INPUT, SOH_ESTIMATE)
...
%     [params, info] = degradation_mode_library('li_plating', 65.0);
%
